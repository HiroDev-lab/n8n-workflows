...
![Status](https://img.shields.io/badge/status-active-brightgreen) ![Platform](https://img.shields.io/badge/platform-n8n-orange) ![Nodes](https://img.shields.io/badge/nodes-4-blue)
...
Encerra conversas automaticamente com base em regras de inatividade ou status.
...
- N8N versão 1.0+
- Credenciais configuradas para: Code (JS/Python), HTTP Request, Webhook
...
Automatically closes conversations based on inactivity rules or status.
...
- N8N version 1.0+
- Credentials configured for: Code (JS/Python), HTTP Request, Webhook

---

*Workflow ID: `dgCeoQciud2Mhoor` | Nodes: 4*
