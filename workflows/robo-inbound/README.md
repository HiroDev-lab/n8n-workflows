...
Robô de atendimento automático para contatos inbound.
...
- N8N versão 1.0+
- Credenciais configuradas para: Batch Processing, Code (JS/Python), Data Transform, HTTP Request, Scheduler, Wait/Delay
...
Automatic attendance robot for inbound contacts.
...
- N8N version 1.0+
- Credentials configured for: Batch Processing, Code (JS/Python), Data Transform, HTTP Request, Scheduler, Wait/Delay

---

*Workflow ID: `ArgxhkuZC2Wx4Bg0` | Nodes: 14*
