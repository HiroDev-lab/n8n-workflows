# Kommit - Sincronizar.Planilha

![Status](https://img.shields.io/badge/status-active-brightgreen) ![Platform](https://img.shields.io/badge/platform-n8n-orange) ![Nodes](https://img.shields.io/badge/nodes-20-blue)
...
- N8N versão 1.0+
- Credenciais configuradas para: Google Sheets, PostgreSQL, Scheduler, Supabase
...
- N8N version 1.0+
- Credentials configured for: Google Sheets, PostgreSQL, Scheduler, Supabase

---

*Workflow ID: `wJFLnDPrZz7lnrtK` | Nodes: 20*
