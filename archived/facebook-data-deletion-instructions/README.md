...
![Status](https://img.shields.io/badge/status-archived-lightgrey) ![Platform](https://img.shields.io/badge/platform-n8n-orange) ![Nodes](https://img.shields.io/badge/nodes-2-blue)
...
Instruções de exclusão de dados para conformidade com a política do Facebook.
...
- N8N versão 1.0+
- Credenciais configuradas para: Webhook
...
Data deletion instructions for Facebook policy compliance.
...
- N8N version 1.0+
- Credentials configured for: Webhook

---

*Workflow ID: `xQzSLPaXYjw2ymsh` | Nodes: 2*
